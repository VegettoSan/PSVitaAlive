/*
 * Package header template adapted from NeoVitaDB Downloader / VitaDB Downloader.
 * Original project: https://github.com/robin994/NeoVitaDB-Downloader
 *
 * This file is derived from source/head.h from the GPL-3.0 licensed project
 * above and is kept as a separate GPL-3.0-compatible component.
 */
#ifndef PSVITAALIVE_HEAD_TEMPLATE_HPP
#define PSVITAALIVE_HEAD_TEMPLATE_HPP

#include <cstdint>

namespace psvitaalive {
namespace head_template {

static constexpr unsigned int size = 1072;
static const uint8_t data[size] = {
    ...
    0x00,0x00,0x00,0x09,0x00,0x00,0x00,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x24,0x00,
...
static_assert(sizeof(data) == size, "Invalid package header template size");
