...
# Clip the detail panel to its visible rectangle.
...
# Modal typography: noticeably larger, while retaining the existing geometry.
for old, new in [
...
# Modal touch target padding. The visible controls stay exactly where they are.
repls = [
    ...
    ('if (hit(x, y, bxClose, by, bw, bh)) {',
     'if (hit(x, y, bxClose - 12, by - 12, bw + 24, bh + 24)) {'),
]
...
# Leave drag behavior intact for scrollable screens; only these confirm/close targets are widened.
